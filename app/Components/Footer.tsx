        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="font-display text-2xl font-bold text-white mb-4">
              Pure African Harvest
            </h3>
            <p className="text-earth-300 leading-relaxed">
              Connecting conscious consumers with premium, sustainably-sourced 
              agricultural products from Africa. Building bridges between communities 
              and creating positive impact through ethical trade.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-green-300 transition-colors">Sustainability</a></li>
